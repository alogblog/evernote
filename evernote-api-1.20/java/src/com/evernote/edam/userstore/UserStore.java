...
public class UserStore {
  ...
  public interface AsyncIface {
    ...
    public void getPremiumInfo(String authenticationToken, AsyncMethodCallback<AsyncClient.getPremiumInfo_call> resultHandler) throws TException;
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void getPremiumInfo(String authenticationToken, AsyncMethodCallback<getPremiumInfo_call> resultHandler) throws TException {
      checkReady();
      getPremiumInfo_call method_call = new getPremiumInfo_call(authenticationToken, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }

    public static class getPremiumInfo_call extends TAsyncMethodCall {
      private String authenticationToken;
      public getPremiumInfo_call(String authenticationToken, AsyncMethodCallback<getPremiumInfo_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.authenticationToken = authenticationToken;
      }

      public void write_args(TProtocol prot) throws TException {
        prot.writeMessageBegin(new TMessage("getPremiumInfo", TMessageType.CALL, 0));
        getPremiumInfo_args args = new getPremiumInfo_args();
        args.setAuthenticationToken(authenticationToken);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public PremiumInfo getResult() throws com.evernote.edam.error.EDAMUserException, com.evernote.edam.error.EDAMSystemException, TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
        TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getPremiumInfo();
      }
    }
  ...
  public static class checkVersion_args implements TBase<checkVersion_args, checkVersion_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public checkVersion_args() {
      ...
      this.edamVersionMinor = (short)20;

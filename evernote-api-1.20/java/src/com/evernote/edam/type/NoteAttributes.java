...
public class NoteAttributes implements TBase<NoteAttributes, NoteAttributes._Fields>, java.io.Serializable, Cloneable {
  ...
  public enum _Fields implements TFieldIdEnum {
    ...
    TASK_DATE((short)18, "taskDate"),
    TASK_COMPLETE_DATE((short)19, "taskCompleteDate"),
    TASK_DUE_DATE((short)20, "taskDueDate"),
  ...
  static {
    ...
    tmpMap.put(_Fields.SHARE_DATE, new FieldMetaData("shareDate", TFieldRequirementType.OPTIONAL, 
        new FieldValueMetaData(TType.I64        , "Timestamp")));
    tmpMap.put(_Fields.TASK_DATE, new FieldMetaData("taskDate", TFieldRequirementType.OPTIONAL, 
        new FieldValueMetaData(TType.I64        , "Timestamp")));
    tmpMap.put(_Fields.TASK_COMPLETE_DATE, new FieldMetaData("taskCompleteDate", TFieldRequirementType.OPTIONAL, 
        new FieldValueMetaData(TType.I64        , "Timestamp")));
    tmpMap.put(_Fields.TASK_DUE_DATE, new FieldMetaData("taskDueDate", TFieldRequirementType.OPTIONAL, 
        new FieldValueMetaData(TType.I64        , "Timestamp")));
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TASK_COMPLETE_DATE:
      if (value == null) {
        ...
        setTaskCompleteDate((Long)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case TASK_DATE:
      return new Long(getTaskDate());

    case TASK_COMPLETE_DATE:
      return new Long(getTaskCompleteDate());

    case TASK_DUE_DATE:
      return new Long(getTaskDueDate());
  ...
  public int compareTo(NoteAttributes other) {
    ...
    lastComparison = Boolean.valueOf(isSetTaskDate()).compareTo(typedOther.isSetTaskDate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTaskDate()) {      lastComparison = TBaseHelper.compareTo(this.taskDate, typedOther.taskDate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetTaskCompleteDate()).compareTo(typedOther.isSetTaskCompleteDate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTaskCompleteDate()) {      lastComparison = TBaseHelper.compareTo(this.taskCompleteDate, typedOther.taskCompleteDate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetTaskDueDate()).compareTo(typedOther.isSetTaskDueDate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTaskDueDate()) {      lastComparison = TBaseHelper.compareTo(this.taskDueDate, typedOther.taskDueDate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }

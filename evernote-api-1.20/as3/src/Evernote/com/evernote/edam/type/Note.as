      ...
      while (true)
      {
        ...
        switch (field.id)
        {
          ...
          case RESOURCES:
            if (field.type == TType.LIST) {
              {
                var _list145:TList = iprot.readListBegin();
                this.resources = new Array();
                for (var _i146:int = 0; _i146 < _list145.size; ++_i146)
                {
                  var _elem147:Resource;
                  _elem147 = new Resource();
                  _elem147.read(iprot);
                  this.resources.push(_elem147);
                }
                iprot.readListEnd();
              }
            } else { 
      ...
      if (this.tagGuids != null) {
        if (isSetTagGuids()) {
          oprot.writeFieldBegin(TAG_GUIDS_FIELD_DESC);
          {
            ...
            for each (var elem151:* in this.tagGuids)            {
      ...
      if (this.resources != null) {
        if (isSetResources()) {
          oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
          {
            ...
            for each (var elem152:* in this.resources)            {
              elem152.write(oprot);
            }
            oprot.writeListEnd();
          }
      ...
      if (this.tagNames != null) {
        if (isSetTagNames()) {
          oprot.writeFieldBegin(TAG_NAMES_FIELD_DESC);
          {
            ...
            for each (var elem153:* in this.tagNames)            {
              oprot.writeString(elem153);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();

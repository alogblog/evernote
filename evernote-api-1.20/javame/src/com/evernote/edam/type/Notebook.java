          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.sharedNotebookIds = new Vector(_list29.size);
              for (int _i30 = 0; _i30 < _list29.size; ++_i30)
              {
                long _elem31;
                _elem31 = iprot.readI64();
                this.sharedNotebookIds.addElement(new Long(_elem31));
              }
              iprot.readListEnd();
            }
          } else { 
    ...
    if (this.sharedNotebookIds != null) {
      if (isSetSharedNotebookIds()) {
        oprot.writeFieldBegin(SHARED_NOTEBOOK_IDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter32_enum = this.sharedNotebookIds.elements(); _iter32_enum.hasMoreElements(); )           {
            Long _iter32 = (Long)_iter32_enum.nextElement();

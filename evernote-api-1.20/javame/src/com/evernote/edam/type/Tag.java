...
public class Tag implements TBase {
  ...
  public int compareTo(Object otherObject) {
    ...
    Tag other = (Tag)otherObject;    int lastComparison = 0;
    ...
    lastComparison = TBaseHelper.compareTo(isSetParentGuid(), other.isSetParentGuid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetParentGuid()) {
      lastComparison = TBaseHelper.compareTo(this.parentGuid, other.parentGuid);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }

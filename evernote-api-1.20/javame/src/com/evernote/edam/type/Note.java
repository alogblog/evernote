...
public class Note implements TBase {
  ...
  public Note(Note other) {
    ...
    if (other.isSetResources()) {
      ...
      for (Enumeration other_enum = other.resources.elements(); other_enum.hasMoreElements(); ) {
        Resource other_element = (Resource)other_enum.nextElement();
        __this__resources.addElement(new Resource(other_element));
      }
    ...
    if (other.isSetTagNames()) {
      Vector __this__tagNames = new Vector();
      for (Enumeration other_enum = other.tagNames.elements(); other_enum.hasMoreElements(); ) {
        String other_element = (String)other_enum.nextElement();
        __this__tagNames.addElement(other_element);
      }
  ...
  public Enumeration getTagNamesEnumeration() {
    return (this.tagNames == null) ? null : this.tagNames.elements();
  }
  ...
  public void setTagNames(Vector tagNames) {
  ...
  public int compareTo(Object otherObject) {
    ...
    Note other = (Note)otherObject;    int lastComparison = 0;
    ...
    lastComparison = TBaseHelper.compareTo(isSetTagNames(), other.isSetTagNames());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTagNames()) {
      lastComparison = TBaseHelper.compareTo(this.tagNames, other.tagNames);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.tagGuids = new Vector(_list17.size);
              for (int _i18 = 0; _i18 < _list17.size; ++_i18)
              {
                String _elem19;
                _elem19 = iprot.readString();
                this.tagGuids.addElement(_elem19);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.resources = new Vector(_list20.size);
              for (int _i21 = 0; _i21 < _list20.size; ++_i21)
              {
                Resource _elem22;
                _elem22 = new Resource();
                _elem22.read(iprot);
                this.resources.addElement(_elem22);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.tagNames = new Vector(_list23.size);
              for (int _i24 = 0; _i24 < _list23.size; ++_i24)
              {
                String _elem25;
                _elem25 = iprot.readString();
                this.tagNames.addElement(_elem25);
              }
              iprot.readListEnd();
            }
          } else { 
    ...
    if (this.tagGuids != null) {
      if (isSetTagGuids()) {
        oprot.writeFieldBegin(TAG_GUIDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter26_enum = this.tagGuids.elements(); _iter26_enum.hasMoreElements(); )           {
    ...
    if (this.resources != null) {
      if (isSetResources()) {
        oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
        {
          ...
          for (Enumeration _iter27_enum = this.resources.elements(); _iter27_enum.hasMoreElements(); )           {
            Resource _iter27 = (Resource)_iter27_enum.nextElement();
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
        }
    ...
    if (this.tagNames != null) {
      if (isSetTagNames()) {
        oprot.writeFieldBegin(TAG_NAMES_FIELD_DESC);
        {
          ...
          for (Enumeration _iter28_enum = this.tagNames.elements(); _iter28_enum.hasMoreElements(); )           {
            String _iter28 = (String)_iter28_enum.nextElement();

...
public class PremiumInfo implements TBase {
  ...
  public int compareTo(Object otherObject) {
    ...
    PremiumInfo other = (PremiumInfo)otherObject;    int lastComparison = 0;
    ...
    lastComparison = TBaseHelper.compareTo(isSetPremium(), other.isSetPremium());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPremium()) {
      lastComparison = TBaseHelper.compareTo(this.premium, other.premium);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetPremiumRecurring(), other.isSetPremiumRecurring());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPremiumRecurring()) {
      lastComparison = TBaseHelper.compareTo(this.premiumRecurring, other.premiumRecurring);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetPremiumExpirationDate(), other.isSetPremiumExpirationDate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPremiumExpirationDate()) {
      lastComparison = TBaseHelper.compareTo(this.premiumExpirationDate, other.premiumExpirationDate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetPremiumExtendable(), other.isSetPremiumExtendable());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPremiumExtendable()) {
      lastComparison = TBaseHelper.compareTo(this.premiumExtendable, other.premiumExtendable);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetPremiumPending(), other.isSetPremiumPending());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPremiumPending()) {
      lastComparison = TBaseHelper.compareTo(this.premiumPending, other.premiumPending);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetPremiumCancellationPending(), other.isSetPremiumCancellationPending());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPremiumCancellationPending()) {
      lastComparison = TBaseHelper.compareTo(this.premiumCancellationPending, other.premiumCancellationPending);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetCanPurchaseUploadAllowance(), other.isSetCanPurchaseUploadAllowance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCanPurchaseUploadAllowance()) {
      lastComparison = TBaseHelper.compareTo(this.canPurchaseUploadAllowance, other.canPurchaseUploadAllowance);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetSponsoredGroupName(), other.isSetSponsoredGroupName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSponsoredGroupName()) {
      lastComparison = TBaseHelper.compareTo(this.sponsoredGroupName, other.sponsoredGroupName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = TBaseHelper.compareTo(isSetSponsoredGroupRole(), other.isSetSponsoredGroupRole());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSponsoredGroupRole()) {
      lastComparison = TBaseHelper.compareTo(this.sponsoredGroupRole, other.sponsoredGroupRole);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("PremiumInfo(");
    boolean first = true;
